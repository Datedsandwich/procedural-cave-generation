...
public class MeshGenerator : MonoBehaviour {
    ...
    void CreateTriangle(Node a, Node b, Node c) {
        ...
        AddTriangle(a.vertexIndex, triangle);
        AddTriangle(b.vertexIndex, triangle);
        AddTriangle(c.vertexIndex, triangle);
    }

    void AddTriangle(int vertexIndexKey, Triangle triangle) {
